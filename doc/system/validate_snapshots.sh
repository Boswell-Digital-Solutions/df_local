...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/DTLSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/DTLSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/DTLSYSTEM.md\`" "assembled primary output"
